...
const Detail = () => {
  ...
  const fetchDetailData = async () => {
    try {
      const response = await axios.get(
        ...
        `https://193.203.162.80:80/detail/${no_do}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("refresh_token")}`,
          },
  ...
  const handleSave = async () => {
    try {
      ...
      await axios.put(`https://193.203.162.80:80/detail/${no_do}`, detailData, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("refresh_token")}`,
        },
      });
  ...
  const handleDelete = async () => {
    try {
      ...
      await axios.delete(`https://193.203.162.80:80/detail/${no_do}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("refresh_token")}`,
        },
      });
